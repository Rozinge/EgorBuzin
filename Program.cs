...
namespace LAB2
{
    class Figures
    {
                ...
                for (int i = 0; i < maxZ; i++)
                {
                    ...
                    for (int j = 0; j < maxY; j++)
                    {
                        ...
                        for (int k = 0; k < maxX; k++)
                        {
                            ...
                            {
                                //Добавить приведенный к строке текущий элемент
        ...
        class SimpleStack<T> : SimpleList<T> where T : IComparable
        {
            ...
            public T Pop()
            {
                ...
                else
                {
                    ...
                    //предпоследний элемент считается последним
                    this.last = newLast;
                    //последний элемент удаляется из списка
                    newLast.next = null;
                }
        ...
        public class SimpleList<T> : IEnumerable<T>            where T : IComparable
        {
            ...
            /// <summary>            /// Первый элемент списка            /// </summary>            protected SimpleListItem<T> first = null;
            /// <summary>
            /// Последний элемент списка
            /// </summary>
            ...
            /// <summary>            /// Добавление элемента            /// </summary>            public void Add(T element)
            {
                ...
                else
                {
                    ...
                    //Присоединенный элемент считается последним
                    this.last = newItem;
                }
            }


            /// <summary>            /// Чтение контейнера с заданным номером            /// </summary>            public SimpleListItem<T> GetItem(int number)
            {
                if ((number < 0) || (number >= this.Count))
                {
                    //Можно создать собственный класс исключения
